                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div className="logo_box">
                                        <Link href="/" className="logo navbar-brand">
                                            <img src="/assets/images/header-logo.png" alt="Vankine " className="logo_default" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div className="d-flex align-items-center contact_header_one">
                                        <div className="icon_s">
                                            <i href="https://www.google.com/maps/place/SAR+Tax+%26+Management+Consultant/@-6.903306,107.6257896,15z/data=!4m2!3m1!1s0x0:0xeda1ba5ef0203c06?sa=X&ved=2ahUKEwihk97Y7uCDAxVZxTgGHefgA8oQ_BJ6BAgNEAA" className=" flaticon-pin" />
                                        </div>
