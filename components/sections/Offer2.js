                    ...
                    <div className="row align-items-end">
                        <div className="col-lg-6 col-md-12">
                            <div className="section_title type_four">
                                <h4 className="sm_title"> Why Should You Choose Us ?</h4>
                                <div className="title_whole">
                                    <h2 className="title"> One Stop Business Solutions</h2>
                                </div>
                                {/*-============spacing==========-*/}
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="position-relative position_p_relative">
                                Our comprehensive approach ensures your business gets the support it needs to grow and succeed. With trusted expertise and tailored solutions, we provide unmatched value to meet your unique requirements.
                                {/*-============spacing==========-*/}
                                <div className="pd_bottom_40" />
                                {/*-============spacing==========-*/}
                            </div>
                                ...
                                <Swiper {...swiperOptions} className="theme_carousel ">
                                    <SwiperSlide className="process_box  type_two hover_1_get color_two">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="title_22">
                                                <Link href="/service">
                                                    Comprehensive Business<br></br> Solutions
                                                </Link>
                                            </div>
                                            <p className="trans">
                                    ...
                                    <SwiperSlide className="process_box  type_two hover_1_get color_two">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="title_22">
                                                <Link href="/service">
                                                    Effortless Client <br></br> Experience
                                                </Link>
                                            </div>
                                            <p className="trans">
                                                Seamless support for your business growth.
                                            </p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="process_box  type_two hover_1_get color_two">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="title_22">
                                                <Link href="/service">
                                                    A Partnership You Can<br></br> Trust
                                                </Link>
                                            </div>
                                            <p className="trans">
                                                Built on integrity and client-first commitment.
                                            </p>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
