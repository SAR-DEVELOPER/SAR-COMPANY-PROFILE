                        ...
                        <div className="col-lg-12">
                            <div className="section_title text-center color_white type_one">
                                ...
                                <div className="title_whole">
                                    <h2 className="title">Great Track Record</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                            <div className="fun_facts type_one color_white">
                                ...
                                <h4>
                                    ...
                                    <CounterUp count={4} time={5} />
                                    <small>
                                        </small></h4>
                                <h6 className="title_no_a_18">Companies</h6>
                            </div>
                            {/*-============spacing==========-*/}
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                            <div className="fun_facts type_one color_white">
                                ...
                                <h4>
                                    ...
                                    <CounterUp count={2000} time={3} />
                                    <small>
                                        + </small></h4>
                                <h6 className="title_no_a_18">Sa</h6>
                            </div>
                            {/*-============spacing==========-*/}
                            <div className="pd_bottom_20" />
                            {/*-============spacing==========-*/}
